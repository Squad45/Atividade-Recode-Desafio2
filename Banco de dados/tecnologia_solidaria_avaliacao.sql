...
CREATE TABLE `avaliacao` (
  `codAva` int NOT NULL AUTO_INCREMENT,
  `fk_codCad` int DEFAULT NULL,
  `avaliacao` char(3) DEFAULT NULL,
  PRIMARY KEY (`codAva`),
  KEY `fk_codCad` (`fk_codCad`),
  CONSTRAINT `avaliacao_ibfk_1` FOREIGN KEY (`fk_codCad`) REFERENCES `cadastro` (`codCad`)
...
INSERT INTO `avaliacao` VALUES (3,1,'SIM'),(4,3,'SIM');
